...
export default function Home() {
  ...
  return <main className="shell">
    ...
    <section className="workspace">
      ...
      <div className="content"><section className="chat-panel"><div className="panel-heading"><span>Conversation</span><b>{running ? "STREAMING" : "LIVE"}</b></div><div className="copilot-chat"><CopilotChat agentId="vibegraph" attachments={{ enabled: true, accept: "image/*,.png,.jpg,.jpeg,.webp,.gif,.pdf", maxSize: 10 * 1024 * 1024 }} labels={{ modalHeaderTitle: "VibeGraph Agent", welcomeMessageText: "Describe a domain or drop an ER diagram image and I'll sketch its semantic model." }} /></div></section>
